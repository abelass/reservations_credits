...
function reservations_credits_declarer_tables_objets_sql($tables) {
  ...
  $tables['spip_reservation_credit_mouvements'] = array(
    ...
    'principale' => "oui",
    'table_objet_surnoms' => array('reservationcreditmouvement'), // table_objet('reservation_credit_mouvement') => 'reservation_credit_mouvements'
    'field' => array(
  ...
  $tables['spip_reservation_credits'] = array(
    ...
    'rechercher_champs' => array("email" => 2),
    'tables_jointures' => array(
    ),
  );
